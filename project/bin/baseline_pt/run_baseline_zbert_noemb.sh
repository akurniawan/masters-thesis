...
#PBS -N akurniawan_mt_baseline_zbert_noemb
...
WANDB_PROJECT=iwslt_baseline_zbert_noemb \
$PYTHON $WORKDIR/experiments_mt.py \
    --enc_config_name bert-base-german-dbmdz-uncased \
    --dec_config_name bert-base-uncased \
    --enc_model_name_or_path /storage/brno3-cerit/home/akurniawan/adapters-project/outputs/bert_de_zeroed_noemb \
    --dec_model_name_or_path /storage/brno3-cerit/home/akurniawan/adapters-project/outputs/bert_en_zeroed_noemb \
    --dataset_loader_script $WORKDIR/dataset/iwslt14/iwslt_loader.py \
    --dataset_config_name de-en \
    --source_lang de \
    --target_lang en \
    --dataset_dir $WORKDIR/dataset/iwslt14 \
    --output_dir $MODELDIR/baseline_zbert_noemb \
