...
#PBS -N akurniawan_mt_adapters_zbert_4_reduction
...
WANDB_PROJECT=iwslt_adapters_zbert \
$PYTHON $WORKDIR/experiments_mt.py \
    ...
    --output_dir $MODELDIR/adapters_zbert_4_reduction \
