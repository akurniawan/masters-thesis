...
#PBS -N akurniawan_mt_bigadapter_bert_bigadapter_randdec
...
WANDB_PROJECT=iwslt_bigadapter_bert_bigadapter_randdec \
$PYTHON $WORKDIR/experiments_mt.py \
    ...
    --source_lang de \
    --target_lang en \
    --output_dir $MODELDIR/bigadapter_bert_bigadapter_randdec \
