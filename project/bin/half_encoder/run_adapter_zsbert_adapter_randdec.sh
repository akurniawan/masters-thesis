...
#PBS -N akurniawan_mt_adapter_zsbert_adapter_randdec
...
WANDB_PROJECT=iwslt_adapter_zsbert_adapter_randdec \
$PYTHON $WORKDIR/experiments_mt.py \
    ...
    --source_lang de \
    --target_lang en \
    --output_dir $MODELDIR/adapter_zsbert_adapter_randdec \
