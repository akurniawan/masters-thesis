...
# using load from disk
# SAMPLE=500000
SAMPLE=2000000
# SAMPLE=40000000
TRANSFORMERS_CACHE=$CACHE_FOLDER WANDB_PROJECT=iwslt_baseline_normal_$SAMPLE $PYTHON $WORKDIR/experiments_mt.py \
    ...
    --source_lang de \
    --target_lang en \
    --output_dir $MODELDIR/baseline_normal_$SAMPLE \
...
#     --output_dir $WORKDIR/outputs/baseline_normal \
#     --max_source_length 512 \
#     --max_target_length 180 \
#     --preprocessing_num_workers 8 \
#     --evaluation_strategy "steps" \
