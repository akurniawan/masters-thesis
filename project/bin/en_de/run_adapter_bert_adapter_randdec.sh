...
#PBS -N akurniawan_mt_adapter_bert_adapter_randdec_en_de
...
WANDB_PROJECT=iwslt_adapter_bert_adapter_randdec_en_de \
$PYTHON $WORKDIR/experiments_mt.py \
    ...
    --source_lang en \
    --target_lang de \
    --output_dir $MODELDIR/adapter_bert_adapter_randdec_en_de \
