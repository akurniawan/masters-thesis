...
#PBS -N akurniawan_mt_adapters_shuffled_both
...
TRANSFORMERS_CACHE=$CACHE_FOLDER WANDB_PROJECT=iwslt_adapters_shuffled_both $PYTHON $WORKDIR/experiments_mt.py \
    ...
    --enc_model_name_or_path /storage/plzen1/home/akurniawan/adapters-project/outputs/bert_de_shuffled_both \
    --dec_model_name_or_path /storage/plzen1/home/akurniawan/adapters-project/outputs/bert_en_shuffled_both \
    --dataset_loader_script $WORKDIR/dataset/iwslt14/iwslt_loader.py \
    --dataset_dir $WORKDIR/dataset/iwslt14 \
    --dataset_config_name de-en \
    --source_lang de \
    --target_lang en \
    --output_dir $MODELDIR/adapters_de_en_pt_shuffled_both \
