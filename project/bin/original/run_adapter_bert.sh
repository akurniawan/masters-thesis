...
#PBS -N akurniawan_mt_adapters_bert
...
TRANSFORMERS_CACHE=$CACHE_FOLDER WANDB_PROJECT=iwslt_adapters_bert $PYTHON $WORKDIR/experiments_mt.py \
    ...
    --dec_model_name_or_path bert-base-uncased \
    --dataset_config_name de-en \
    --source_lang de \
    --target_lang en \
    --output_dir $MODELDIR/adapters_de_en_bert \
