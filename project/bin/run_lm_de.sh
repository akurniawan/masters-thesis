...
WANDB_API_KEY=$API_KEY WANDB_PROJECT=iwslt_lm_$LANG\_$SAMPLE $PYTHON $WORKDIR/experiments_mlm.py \
    --model_type bert \
    --config_name bert-base-german-dbmdz-uncased \
...
# WANDB_API_KEY=$API_KEY WANDB_PROJECT=iwslt_lm_$LANG $PYTHON $WORKDIR/experiments_mlm.py \
#     --model_type bert \
#     --config_name bert-base-german-dbmdz-uncased \
#     --tokenizer_name bert-base-german-dbmdz-uncased \
#     --train_file $WORKDIR/dataset/iwslt14/train.$LANG \
#     --validation_file $WORKDIR/dataset/iwslt14/train.$LANG \
#     --output_dir $WORKDIR/outputs/iwslt_lm_$LANG \
#     --preprocessing_num_workers 8 \
#     --evaluation_strategy "steps" \
#     --load_best_model_at_end True \
#     --learning_rate 0.0001 \
