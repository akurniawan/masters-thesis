...
#PBS -N akurniawan_mt_bigadapter_randenc_bigadapter_zbert
...
WANDB_PROJECT=iwslt_bigadapter_randenc_bigadapter_zbert \
$PYTHON $WORKDIR/experiments_mt.py \
    ...
    --source_lang de \
    --target_lang en \
    --output_dir $MODELDIR/bigadapter_randenc_bigadapter_zbert \
