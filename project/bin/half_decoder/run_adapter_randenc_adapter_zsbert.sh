...
#PBS -N akurniawan_mt_adapter_randenc_adapter_zsbert
...
WANDB_PROJECT=iwslt_adapter_randenc_adapter_zsbert \
$PYTHON $WORKDIR/experiments_mt.py \
    ...
    --source_lang de \
    --target_lang en \
    --output_dir $MODELDIR/adapter_randenc_adapter_zsbert \
