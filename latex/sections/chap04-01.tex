...
The aim of this Chapter is to understand the impact of pre-trained models when fine-tuning machine translation model with adapters. We propose to use Transformer architecture with BERT and manually trained language models as the pre-train weights in both encoder and decoder components while using adapters for the fine-tuning. To be more specific, we divide the experiments into four different areas:
\begin{itemize}
...
\subsection{Machine Translation}
\subsubsection{Adapters Comparison}
\begin{figure}[h]
...
\subsubsection{Random and Shuffled Pre-training Weights}
...
\subsubsection{Random Pretraining vs. Out-of-Domain Data}
