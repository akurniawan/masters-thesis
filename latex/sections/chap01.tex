...
\begin{figure}[h]
    ...
    \centering
    \caption{Illustration of seq2seq architecture.\footnote{Figure reprinted from \protect\url{https://www.guru99.com/seq2seq-model.html}.}}
...
\begin{figure}[h]
    ...
    \centering
    \caption{Illustration of seq2seq architecture with attention.\footnote{Figure reprinted from \protect\url{https://lena-voita.github.io/nlp_course/seq2seq_and_attention.html}.}}
